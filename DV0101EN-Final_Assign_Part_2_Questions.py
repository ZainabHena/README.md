...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                 ...
                 names='Vehicle_Type',
                 title="Advertising_Expenditure by Vehicle Type during recession periods"
                )
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(mas,
            x='Month',
            y='Automobile_Sales',
            title="Automobile sales per month in the year {}".format(input_year)))
        ...
        Y_chart3 = dcc.Graph( figure=px.bar( 
            avr_vdata,
            x='Vehicle_Type',
            y='Automobile_Type',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
